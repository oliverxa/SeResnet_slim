...
def pruned_model(num_classes=10, cfg=None): # without maxpooling
    return SEResnet2(SeBottleneck, [3,4,23,3], num_classes=num_classes, cfg=cfg)


def test():
    net = new_model()
    y = net(torch.randn(1,3,32,32))
    print(net, file=open("newmodel.txt","w"))
    print(y.size())
